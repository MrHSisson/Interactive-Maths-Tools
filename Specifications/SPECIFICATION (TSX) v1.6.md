# Math Tool Core System - Technical Specification v1.6
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {mode === 'single' && question && (
          <>
            ...
            {/* Question Display */}
            <div className="bg-white rounded-xl shadow-2xl p-8" style={{ minHeight: '120vh' }}>
        ...
        {mode === 'worksheet' && (
          <>
            {/* Controls */}
            <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
              {/* Control bar content - unchanged from v1.5 */}
            </div>
...
**Rationale:** Dark green (`#166534`) provides excellent contrast for projected displays while clearly distinguishing answers from questions. The slightly larger worksheet green (`#059669`) maintains visibility at smaller font sizes.
...
```
Creates: Three modes, difficulty levels, adjustable columns, font size controls, green worksheet answers, dark green answers (Whiteboard/Single Q)
...
- Added Feature 4: Green Worksheet Answers (now standard)
  - Color: #059669
  - Exception to black text rule for pedagogical distinction
- Expanded Feature 1: Additional Color Schemes
  - Added Pink: #F8D1E7 (primary), #F2B3D9 (secondary)
  - Added Yellow: #F8F4D1 (primary), #F2EBB3 (secondary)
- Updated Feature 2: Simplified Menu Labels
  - Now shows: Default, Blue, Pink, Yellow
  - Removed "(Dyslexia-friendly)" text
- Updated helpers to support all four color schemes
