# Math Tool Core System - Technical Specification v1.5
...
- Show/hide answers (green for visual distinction)
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* WHITEBOARD & SINGLE Q - unchanged from v1.4 */}

        {/* WORKSHEET */}
        {mode === 'worksheet' && (
          <>
            {/* Controls - unchanged from v1.4 */}
...
**Exception 2:** Green answers in worksheet mode (see Feature 3).
...
**Step 4: Make text black (with green answer exception):**
```tsx
...
✅ Right: ALL text on colored backgrounds is `color: '#000000'` (except green answers)
...
- [ ] All visual representations use helpers
- [ ] ALL text on colored backgrounds is black `#000000` (except green answers)
...
### **Feature 4 (Standard - Green Answers)**
...
```
Creates: Three modes, difficulty levels, adjustable columns, font size controls, green answers
...
- Black text on colored backgrounds (green for worksheet answers)
